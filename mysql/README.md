This is a chart of mysql copied from [stable/mysql](https://github.com/helm/charts/tree/master/stable/mysql) because of its deprecation. 
...
```bash
$ helm install --name my-release chatwork/mysql
```
...
```bash
$ helm install --name my-release -f values.yaml chatwork/mysql
```
